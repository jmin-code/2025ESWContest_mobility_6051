...
하지만, 이러한 음성 기반 인터페이스는 **언어 및 청각 장애가있는 운전자**에게는 사실상 사용이 불가능한 서비스이다. 
...
이에 더해, GPS 기반의 스마트 내비게이션으로 주행 편의성을 극대화하고, 위급 상황 시 원터치로 작동하는 긴급 SOS 시스템을 탑재하여 운전자의 안전을 최우선으로 확보한다. 본 시스템은 기술의 혜택을 모두가 누릴 수 있도록 돕는 **포용적인 솔루션**을 지향한다.
...
| 🚗 **안전 모드 (Safe Mode)** | 차량이 설정된 속도(예: 30km/h)를 초과할 경우, 운전자의 주의 분산을 방지하기 위해 수어 인식 시스템의 작동을 자동으로 중단합니다. |
